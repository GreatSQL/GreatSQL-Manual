...
[点击此处](https://gitee.com/GreatSQL/GreatSQL/releases/tag/GreatSQL-8.0.32-26)下载最新的安装包，至少下载以下几个RPM包文件：
...
**提示**：建议直接下载RPM集中打包文件，例如 greatsql-8.0.32-26.1.el8.x86_64.rpm-bundle.tar.xz，就无需每个文件单独下载了。
