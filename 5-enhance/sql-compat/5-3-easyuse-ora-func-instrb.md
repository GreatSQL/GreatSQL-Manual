...
## 4. 示例
```
greatsql> SELECT INSTRB('GreatSQL具备高性能、高可靠、高易用性、高安全等多个核心特性', '高');
+------------------------------------------------------------------------------------------------------+
| INSTRB('GreatSQL具备高性能、高可靠、高易用性、高安全等多个核心特性', '高')                           |
+------------------------------------------------------------------------------------------------------+
|                                                                                                   15 |
+------------------------------------------------------------------------------------------------------+

greatsql> SELECT INSTRB('GreatSQL具备高性能、高可靠、高易用性、高安全等多个核心特性', '高', 1, 1);
+------------------------------------------------------------------------------------------------------------+
| INSTRB('GreatSQL具备高性能、高可靠、高易用性、高安全等多个核心特性', '高', 1, 1)                           |
+------------------------------------------------------------------------------------------------------------+
|                                                                                                         15 |
+------------------------------------------------------------------------------------------------------------+

greatsql> SELECT INSTRB('GreatSQL具备高性能、高可靠、高易用性、高安全等多个核心特性', '高', 1, 2);
+------------------------------------------------------------------------------------------------------------+
| INSTRB('GreatSQL具备高性能、高可靠、高易用性、高安全等多个核心特性', '高', 1, 2)                           |
+------------------------------------------------------------------------------------------------------------+
|                                                                                                         27 |
+------------------------------------------------------------------------------------------------------------+
