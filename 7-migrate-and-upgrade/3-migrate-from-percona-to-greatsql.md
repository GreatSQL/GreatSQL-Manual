...
如果是前两种，可以参考文档：[GreatSQL 5.7升级到8.0](https://gitee.com/GreatSQL/GreatSQL-Manual/blob/master/7-migrate-and-upgrade/7-1-upgrade-to-greatsql8.md) 的方法进行迁移/升级即可，过程是完全一样的。

如果是第三种场景，可以参考文档：[从MySQL迁移/升级到GreatSQL](https://gitee.com/GreatSQL/GreatSQL-Manual/blob/master/7-migrate-and-upgrade/7-2-migrate-from-mysql-togreatsql.md) 中介绍的 **逻辑备份+导入** 方法，进行降级处理。
