...
从GreatSQL 8.0.32-25版本开始，支持大规模并行、高性能的内存查询加速AP引擎，可将数据分析性能提升几个数量级。在32C64G测试机环境下，TPC-H 100G测试中22条SQL总耗时仅需不到80秒。更详细内容参考：[Rapid引擎](../5-enhance/5-1-highperf-rapid-engine.md)。
