...
[点击此处](https://gitee.com/GreatSQL/GreatSQL/releases/tag/GreatSQL-8.0.32-24)下载最新的二进制安装包，可从下面几个任选一个（推荐下载minimal包，体积更小）：
...
file_name: GreatSQL-8.0.32-24-Linux-glibc2.28-x86_64-minimal.tar.xz
base_dir: /usr/local/GreatSQL-8.0.32-24-Linux-glibc2.28-x86_64-minimal
my_cnf: /etc/my.cnf
mysql_user: mysql
mysql_port: 3306
mgr_user: GreatSQL
...
|file_name|GreatSQL-8.0.32-24-Linux-glibc2.28-x86_64-minimal.tar.xz|GreatSQL二进制包文件名，【不建议调整】|
|base_dir|/usr/local/GreatSQL-8.0.32-24-Linux-glibc2.28-x86_64-minimal|GreatSQL的basedir，【不建议调整】|
...
$ cd /opt/greatsql
$ ls
check_mysql.yml                                           GreatSQL-8.0.32-24-Linux-glibc2.28-x86_64-minimal.tar.xz.md5  mysql-support-files
GreatSQL-8.0.32-24-Linux-glibc2.28-x86_64-minimal.tar.xz  greatsql.yml                                                  vars.yml
