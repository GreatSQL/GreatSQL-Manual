...
那么在这个环境下，可以选择 [GreatSQL-8.4.4-5-Linux-glibc2.28-x86_64.tar.xz](https://gitee.com/GreatSQL/GreatSQL/releases/tag/GreatSQL-8.4.4-5) 这个二进制包进行安装。若glibc为2.17，请选择带有"glibc2.17"标识的安装包。
